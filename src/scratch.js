!function (e) {
  ...
  (function (e) {
    ...
    var r = n(1), o = t(r), i = n(77), a = t(i), u = n(11), s = n(3), l = n(6), c = t(l), d = n(40), f = t(d),
      p = n(47), h = t(p);
    e.Draft = c.default, e.hemingwayStore = (0, u.createStore)(h.default), a.default.render(o.default.createElement(s.Provider, {store: e.hemingwayStore}, o.default.createElement(f.default, null)), document.getElementById("hemingway")), window.onbeforeunload = function () {
  ...
  e.exports = {
    readability: {normal: "normalReadability", hard: "hardReadability", veryHard: "veryHardReadability"},
    tokens: {
      adverb: "adverb",
  ...
  function o(e) {
    var t = T(e), n = S(e).getBlockForKey(t), r = n.getDepth();
    if (0 === r) return y.RichUtils.toggleBlockType(e, "unstyled");
    var o = S(e).getBlockMap(), i = o.setIn([t, "depth"], r - 1),
      a = y.ContentState.createFromBlockArray(i.toArray()), u = e.getDecorator(),
      s = y.EditorState.createWithContent(a, u), l = y.SelectionState.createEmpty(t);
  ...
  function u(e) {
    var t = e.getSelection(), n = t.isCollapsed();
    if (n) {
      var r = t.getFocusKey(), o = e.getCurrentContent().getBlockForKey(r), i = o.getLength(), a = o.getType();
  ...
  function s(e, t, n) {
    var r = y.DefaultDraftBlockRenderMap.set("p", {element: "p"}),
    ...
    var i = e.getCurrentContent(), a = e.getSelection(), u = y.BlockMapBuilder.createFromArray(o),
      s = y.Modifier.replaceWithFragment(i, a, u);
    return y.EditorState.push(e, s, "insert-fragment")
  }

  function l(e, t) {
    var n = t.blockKey, r = t.startIndex, o = t.oldText, i = t.newText, a = t.trailingSpace,
      u = y.SelectionState.createEmpty(n), s = a && "" === i ? 1 : 0,
      l = u.merge({anchorOffset: r, focusOffset: r + o.length + s}), c = S(e),
  ...
  function p(e, t) {
    var n = y.Entity.create("LINK", "MUTABLE", {href: t});
    return y.RichUtils.toggleLink(e, e.getSelection(), n)
  }

  function h(e, t) {
    if ("split-block" === e.getLastChangeType()) {
      var n = S(e), r = T(e), o = n.getBlockBefore(r),
        i = v.default.pipe(v.default.invoker(0, "getText"), b.default.run, v.default.prop("stats"))(o);
      t(o.getKey(), i)
    }
  }

  Object.defineProperty(t, "__esModule", {value: !0}), t.getText = t.createEmptyEditorState = t.createEditorState = void 0, t.decreaseIndent = o, t.handleKeyCommand = i, t.handleTab = a, t.isOnEmptyListItem = u, t.overridePaste = s, t.replaceString = l, t.setSelection = c, t.toggleBlockType = d, t.toggleInlineStyle = f, t.toggleLink = p, t.trackLastBlockAfterSplit = h;
  var y = n(6), g = n(4), v = r(g), m = n(15), b = r(m), w = v.default.invoker(0, "getSelection"),
    T = v.default.pipe(w, v.default.invoker(0, "getFocusKey")), S = v.default.invoker(0, "getCurrentContent");
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0});
  var r = n(4), o = (0, r.prop)("items"), i = function (e, t) {
    return (0, r.concat)(e, o(t))
  }, a = (0, r.reduce)(i, []), u = (0, r.pipe)(o, a), s = {
    getSentences: u, iterateOverSentences: function (e, t) {
  ...
  var o = n(62), i = n(63), a = n(65), u = "[object Object]", s = Object.prototype, l = Function.prototype.toString,
    c = s.hasOwnProperty, d = l.call(Object), f = s.toString;
  e.exports = r
}, function (e, t, n) {
  "use strict";
  ...
  var o = n(21), i = r(o), a = n(72), u = r(a), s = n(71), l = r(s), c = n(70), d = r(c), f = n(20), p = r(f),
    h = n(22);
  r(h);
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0}), t.turnOnURLInputAction = t.turnOffURLInputAction = t.toggleLinkAction = t.toggleInlineStyleAction = t.toggleBlockTypeAction = void 0;
  var r = n(5);
  t.toggleBlockTypeAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.toggleBlockType)(e, t)}
  }, t.toggleInlineStyleAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.toggleInlineStyle)(e, t)}
  }, t.toggleLinkAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE_AND_HIDE_URL", editorState: (0, r.toggleLink)(e, t)}
  }, t.turnOffURLInputAction = function () {
    return {type: "HIDE_URL_INPUT"}
  }, t.turnOnURLInputAction = function () {
    return {type: "SHOW_URL_INPUT"}
  }
}, function (e, t, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0}), t.replaceStringAction = t.hideTooltipAction = t.showTooltipAction = void 0;
  var r = n(5);
  t.showTooltipAction = function (e) {
    return {type: "SHOW_TOOLTIP", options: e}
  }, t.hideTooltipAction = function () {
    return {type: "HIDE_TOOLTIP"}
  }, t.replaceStringAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.replaceString)(e, t)}
  }
}, function (e, t) {
  "use strict";

  function n() {
    return {type: "TOGGLE_WRITE_EDIT"}
  }
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(4), i = n(53), a = r(i), u = n(16), s = r(u), l = n(52), c = r(l),
  ...
  var o = n(2), i = r(o), a = n(8), u = r(a), s = {
    score: function (e) {
      ...
      var t = e.items.length, n = this.countLetters(e.items), r = this.getReadingLevel(n, t, 1),
        o = this.getReadabilityStyle({words: t, readingLevel: r});
      return {words: t, letters: n, readingLevel: r, readability: o}
      ...
      var t = e.words, n = e.readingLevel;
      ...
      var t = this.countStatFromSentences(e, "letters"), n = e.text.length,
        r = this.countStatFromSentences(e, "words"), o = this.countSentences(e), i = e.items.length,
        a = this.getReadingLevel(t, r, o), u = this.getReadabilityStyle({words: r, readingLevel: a}),
      ...
      var t = this, n = {adverbs: 0, passiveVoices: 0, complexWords: 0, hardSentences: 0, veryHardSentences: 0};
  ...
  var i = n(10), a = r(i), u = n(73), s = r(u), l = t.ActionTypes = {INIT: "@@redux/INIT"}
}, function (e, t) {
  "use strict";
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0}), t.onTabAction = t.onChangeAction = t.overridePastedTextAction = t.handleKeyCommandAction = t.decreaseIndentAction = void 0;
  var r = n(5);
  t.decreaseIndentAction = function (e) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.decreaseIndent)(e)}
  }, t.handleKeyCommandAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.handleKeyCommand)(e, t)}
  }, t.overridePastedTextAction = function (e, t, n) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.overridePaste)(e, t, n)}
  }, t.onChangeAction = function (e) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: e}
  }, t.onTabAction = function (e, t) {
    return {type: "UPDATE_EDITOR_CONTENT_STATE", editorState: (0, r.handleTab)(e, t)}
  }
}, function (e, t) {
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0});
  var n = function (e, t) {
    return {type: "STATS_TRACK_BLOCK", key: e, stats: t}
  };
  t.default = n
}, function (e, t, n) {
  "use strict";
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = r(o), a = function (e) {
    return i.default.createElement("a", {href: e.href}, e.children)
  };
  a.propTypes = {
    href: i.default.PropTypes.string.isRequired,
    children: i.default.PropTypes.any
  }, a.defaultProps = {children: ""}, t.default = a
}, function (e, t, n) {
  "use strict";
  ...
  var u = function () {
  ...
  }(), s = n(1), l = r(s), c = n(6), d = n(46), f = r(d), p = n(5), h = function (e) {
    function t(e) {
      o(this, t);
      var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
    ...
    return a(t, e), u(t, [{
      ...
      key: "onTab", value: function (e) {
        return this.props.onTab(this.props.editorState, e), !0
      }
    }, {
      key: "bindKeys", value: function (e) {
        var t = c.KeyBindingUtil.hasCommandModifier, n = t(e);
      ...
      key: "handleKeyCommand", value: function (e) {
      ...
      key: "overridePastedText", value: function e(t, n) {
        var r = function (e) {
          return e.match(/^<meta charset='utf-8'><[a-z0-9]+ class="" data-block="true"/)
        };
        if (n && !r(n)) {
          var o = this.props, i = o.editorState, e = o.overridePastedText;
          return e(i, t, n), !0
        }
        return !1
      }
      ...
      key: "render", value: function () {
        var e = this, t = this.props.editorState ? this.props.editorState : this.initialEditorState;
        return l.default.createElement("div", {className: "hemingway-editor-draft-container"}, l.default.createElement(c.Editor, {
          editorState: t,
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = r(o), a = n(39), u = r(a), s = n(42), l = r(s), c = n(41), d = r(c), f = n(43), p = r(f),
    h = n(44), y = r(h), g = function (e) {
      return i.default.createElement("div", {
        id: "hemingway-container",
        className: "hemingway-editor-" + e.editMode
      }, i.default.createElement("div", {className: "hemingway-sidebar"}, i.default.createElement(y.default, null), i.default.createElement("img", {
        className: "hemingway-logo",
        src: "img/logo.png",
        alt: "Hemingway Logo"
      }), i.default.createElement(d.default, null)), i.default.createElement("div", {className: "hemingway-editor-container"}, i.default.createElement("div", {className: "hemingway-editor-components-container"}, i.default.createElement(l.default, null), i.default.createElement(u.default, null)), i.default.createElement(p.default, null)))
    };
  g.propTypes = {editMode: i.default.PropTypes.string.isRequired}, t.default = g
}, function (e, t, n) {
  "use strict";
  ...
  Object.defineProperty(t, "__esModule", {value: !0}), t.getHighlightCommentary = t.formatTime = t.getCappedReadingLevel = t.getReadabilityLabel = void 0;
  var u = function () {
    function e(e, t) {
      for (var n = 0; n < t.length; n++) {
        var r = t[n];
  ...
  }(), s = n(1), l = r(s), c = n(2), d = r(c), f = n(9), p = t.getReadabilityLabel = function (e) {
    switch (e) {
    ...
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, t = Math.floor(e / 3600) || 0,
      n = Math.floor((e - 3600 * t) / 60) || 0, r = Math.floor(e - 3600 * t - 60 * n) || 0, o = g;
    return o(t) + ":" + o(n) + ":" + o(r)
  }, m = function (e) {
    ...
    var r = Math.round(n / 3), o = Math.round(t / 5);
    switch (e.name) {
      case"adverbs":
    ...
    return Object.keys(e).map(function (t) {
      ...
      }, l.default.createElement("strong", {className: "hemingway-highlight-item-value"}, e.value), b(e, t, n))
    })
  }, S = function (e) {
    function t(e) {
      o(this, t);
      var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
      return n.toggleShowMore = n.toggleShowMore.bind(n), n.state = {showAllStats: !1}, n
    }

    return a(t, e), u(t, [{
      key: "getStatItems", value: function (e) {
        ...
        return n.filter(function (e) {
          ...
          return {value: e[t], name: (0, f.capitalize)("readingSeconds" === t ? "reading time" : t)}
        }).map(function (e) {
          return m(e)
        })
      }
    }, {
      key: "toggleShowMore", value: function () {
        this.setState({showAllStats: !this.state.showAllStats})
      }
    }, {
      key: "render", value: function () {
        var e = this.props.stats, t = e.sentences, n = e.paragraphs, r = e.highlights, o = e.readability,
          i = e.readingLevel, a = this.state.showAllStats ? "Less" : "More";
        return l.default.createElement("div", {className: "hemingway-stats-container"}, l.default.createElement("hr", null), l.default.createElement("div", {className: "hemingway-readability-label-container"}, l.default.createElement("h3", {className: "hemingway-readability-title"}, "Readability"), l.default.createElement("h4", {className: "hemingway-readability-" + o.toLowerCase()}, h(i)), l.default.createElement("p", {className: "hemingway-readability-label-aside"}, w(o, i))), l.default.createElement("hr", null), l.default.createElement("div", {className: "hemingway-stat-items-container"}, this.getStatItems(e), l.default.createElement("div", {className: "hemingway-show-more-container"}, l.default.createElement("button", {
          className: "hemingway-show-more-btn",
          onClick: this.toggleShowMore
        }, "Show ", a, l.default.createElement("span", {className: "hemingway-arrow-" + a.toLowerCase()}, " ")))), l.default.createElement("hr", null), l.default.createElement("div", {className: "hemingway-highlight-items-container"}, T(r, t, n)))
      }
    }]), t
  }(l.default.Component);
  S.propTypes = {stats: l.default.PropTypes.object.isRequired}, t.default = S
}, function (e, t, n) {
  "use strict";
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = r(o), a = n(7), u = r(a),
    s = [{label: "H1", style: "header-one"}, {label: "H2", style: "header-two"}, {
      label: "H3",
      style: "header-three"
    }, {label: "Quote", style: "blockquote"}, {label: "Bullets", style: "unordered-list-item"}, {
      label: "Numbers",
      ...
      return i.default.createElement("div", {className: "hemingway-richtext-block-container"}, s.map(function (t) {
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = r(o), a = n(7), u = r(a),
    s = [{label: "Bold", style: "BOLD"}, {label: "Italic", style: "ITALIC"}], l = function (e) {
      return e.getCurrentInlineStyle()
    }, c = function (e) {
      return i.default.createElement("div", {className: "hemingway-richtext-inline-container"}, s.map(function (t) {
        return i.default.createElement(u.default, {
          key: t.label,
  ...
  var u = function () {
  ...
  }(), s = n(1), l = r(s), c = n(7), d = r(c), f = {url: ""}, p = function (e) {
    function t(e) {
      o(this, t);
      var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
    ...
    return a(t, e), u(t, [{
      ...
      key: "render", value: function () {
        ...
        }), this.props.showURLInput ? l.default.createElement("div", {className: "hemingway-richtext-url-input-container"}, l.default.createElement("input", {
          type: "text",
        ...
        }), l.default.createElement("button", {onClick: this.saveUrl}, "Save"), l.default.createElement("button", {onClick: this.cancel}, "Cancel")) : null)
      }
    }]), t
  }(l.default.Component);
  p.propTypes = {
  ...
  var u = function () {
  ...
  }(), s = n(1), l = r(s), c = n(31), d = r(c), f = n(32), p = r(f), h = n(33), y = r(h), g = function (e) {
    function t(e) {
      o(this, t);
      var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
    ...
    return a(t, e), u(t, [{
      key: "render", value: function () {
        return l.default.createElement("div", {className: "hemingway-richtext-toolbar-container"}, l.default.createElement("div", {className: "hemingway-richtext-toolbar-inner-container " + (this.props.showURLInput ? "hemingway-show-url-input" : "")}, l.default.createElement(p.default, {
  ...
  var u = function () {
    ...
    return a(t, e), u(t, [{
      key: "componentWillReceiveProps", value: function (e) {
        var t = this, n = this.state.showTooltip && !e.options.showTooltip,
      ...
      key: "replaceString", value: function (e) {
      ...
      key: "render", value: function () {
        var e = this, t = this.state, n = t.message, r = t.replacements, o = t.type, i = t.offsetCenter,
          a = t.offsetTop, u = t.showTooltip, s = p(o);
        ...
        }, l.default.createElement("h4", null, l.default.createElement("em", null, s), ": ", n), l.default.createElement("div", {className: "hemingway-tooltip-suggestions-container"}, r.map(function (t) {
  ...
  }, h.defaultProps = {editorState: {}}, t.default = h
}, function (e, t, n) {
  "use strict";
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = r(o), a = n(9), u = function (e, t, n) {
    var r = e === n, o = r ? "" : "hemingway-inactive-btn";
    ...
    return i.default.createElement("div", {className: "hemingway-edit-toggle-container"}, ["write", "edit"].map(function (t) {
  ...
  function o() {
    return {
      ...
      sentences: 0,
      paragraphs: 0,
      highlights: {adverbs: 0, passiveVoices: 0, complexWords: 0, hardSentences: 0, veryHardSentences: 0}
    }
  }
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(1), a = (r(i), n(26)), u = r(a), s = n(13), l = function (e) {
    var t = e.editor;
    return {editMode: t.editMode}
  }, c = {hideTooltip: s.hideTooltipAction, showTooltip: s.showTooltipAction};
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(1), a = (r(i), n(28)), u = r(a), s = n(24), l = n(25), c = r(l), d = n(12), f = n(14), p = r(f),
    h = function (e) {
      var t = e.editor, n = e.toolbar;
      return {editorState: t.editorState, showURLInput: n.showURLInput}
    }, y = {
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(29), a = r(i), u = function (e) {
    var t = e.editor;
    return {editMode: t.editMode}
  };
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(1), i = (r(o), n(3)), a = n(30), u = r(a), s = n(54), l = r(s), c = function (e) {
    var t = e.stats, n = e.editor, r = t.blocks, o = void 0;
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(1), a = (r(i), n(34)), u = r(a), s = n(12), l = function (e) {
    var t = e.editor, n = e.toolbar;
    return {editorState: t.editorState, showURLInput: n.showURLInput}
  }, c = {
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(1), a = (r(i), n(35)), u = r(a), s = n(13), l = function (e) {
    var t = e.tooltip, n = e.editor;
    return {editorState: n.editorState, options: t}
  }, c = {replaceString: s.replaceStringAction};
  t.default = (0, o.connect)(l, c)(u.default)
}, function (e, t, n) {
  "use strict";
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(3), i = n(36), a = r(i), u = n(14), s = r(u), l = function (e) {
    var t = e.editor;
    return {editMode: t.editMode}
  }, c = {toggleEditMode: s.default};
  t.default = (0, o.connect)(l, c)(a.default)
}, function (e, t, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0});
  var r = n(4), o = n(5), i = function (e, t) {
    ...
    u = {editorState: (0, o.createEmptyEditorState)(), editMode: "edit"}, s = function () {
  ...
  function a(e) {
    var t = e.getLastBlock().getKey(), n = e.getBlockBefore(t).getKey(), r = e.getBlockBefore(n).getKey(),
      o = u.SelectionState.createEmpty(r), i = o.merge({anchorOffset: 8, focusOffset: 14}),
      a = u.Modifier.applyInlineStyle(e, i, "BOLD"), s = o.merge({anchorOffset: 20, focusOffset: 24}),
      l = u.Modifier.applyInlineStyle(a, s, "ITALIC");
    return l
  }

  Object.defineProperty(t, "__esModule", {value: !0});
  var u = n(6), s = n(23), l = n(58), c = r(l), d = n(51), f = r(d), p = {}, h = Math.pow(2, 24), y = function (e) {
    var t = i(), n = u.ContentState.createFromBlockArray(t), r = a(n),
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(11), i = n(45), a = r(i), u = n(48), s = r(u), l = n(50), c = r(l), d = n(49), f = r(d),
    p = (0, o.combineReducers)({editor: a.default, stats: s.default, tooltip: c.default, toolbar: f.default});
  t.default = p
}, function (e, t) {
  "use strict";

  function n(e, t) {
    var n = t.key, r = t.stats, o = Object.assign({}, e), i = o.blocks.find(function (e) {
      return e.key === n
    });
    return i ? i.stats = r : o.blocks = o.blocks.concat([{key: n, stats: r}]), o
  }

  Object.defineProperty(t, "__esModule", {value: !0});
  var r = {blocks: []}, o = function () {
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", {value: !0});
  var r = n(4), o = (0, r.lensProp)("showURLInput"), i = (0, r.set)(o, !0), a = (0, r.set)(o, !1),
    u = {showURLInput: !1}, s = function () {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : u, t = arguments[1];
      switch (t.type) {
        case"SHOW_URL_INPUT":
          return i(e, t);
  ...
  function o(e) {
    var t = e.target.getBoundingClientRect(), n = t.left, r = t.top, o = t.width;
    return {offsetTop: r, offsetCenter: n + o / 2}
  }

  function i(e, t) {
    var n = t.options, r = n.word, i = n.type, a = n.event,
    ...
    if (u) {
      var l = o(a), d = (0, c.default)(r, i), f = Object.assign({}, l, d, t.options);
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var u = n(2), s = r(u), l = n(55), c = r(l), d = {showTooltip: !1}, f = function () {
  ...
  var i = function () {
    ...
    }(), a = n(23), u = n(6), s = n(1), l = (r(s), n(38)), c = r(l), d = n(27), f = r(d), p = n(15), h = r(p), y = n(8),
    g = r(y), v = function () {
      function e(t) {
      ...
      return i(e, [{
        key: "getDecorations", value: function (t) {
          var n = t.getText(), r = h.default.run(n);
          ...
          }, Array(n.length).fill(null)), i = e.addEntitiesToDecorations(o, t, u.Entity);
          return (0, a.List)(i)
        }
      }, {
        key: "getComponentForKey", value: function (e) {
          var t = e.split("-"), n = t[0];
          return "link" === n ? f.default : c.default
        }
      }, {
        key: "getPropsForKey", value: function (t) {
          return e.getPropsForKeyActual(t, u.Entity)
        }
      }], [{
        key: "getPropsForKeyActual", value: function (e, t) {
          var n = e.split("-"), r = n[0], o = n[1];
          if ("link" === r) {
            var i = o;
            return {href: t.get(i).getData().href}
          }
          var a = o;
          return {type: r, trailingSpace: "true" === a}
        }
      }, {
        key: "addHighlightsToDecorations", value: function (e, t) {
          return t.highlights.forEach(function (t) {
            var n = t.startIndex, r = t.endIndex, o = t.style,
        ...
        key: "addEntitiesToDecorations", value: function (e, t, n) {
          var r = e, o = void 0;
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(4), i = r(o), a = n(2), u = r(a), s = n(8), l = r(s), c = function (e) {
    return e.stats.readability === u.default.readability.hard
  }, d = function (e) {
    return e.stats.readability === u.default.readability.veryHard
  }, f = i.default.either(c, d), p = i.default.complement(f), h = function (e, t, n) {
    return e[t] = n, e
  }, y = i.default.curry(h), g = {
    highlight: function (e) {
      ...
      var t = this, n = [], r = this.getTextHighlightAfterToken(e, e.startIndex, e.tokens);
      return r && n.push(r), e.tokens.reduce(function (n, r, o, i) {
        var a = t.makeHighlightFromToken(r);
        n.push(a);
        var u = t.getLastIndex(r) + 1, s = i.slice(o + 1), l = t.getTextHighlightAfterToken(e, u, s);
        return l && n.push(l), n
      }, n)
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(60), i = r(o), a = n(59), u = r(a), s = n(17), l = r(s), c = n(61), d = r(c), f = n(2), p = r(f), h = 2e3,
    y = {
      parse: function () {
        ...
        return {type: e, text: t, startIndex: n}
      }, buildItems: function (e) {
        var t = this.getItemDelimiter(e.type), n = this.splitString(e.text, t);
        return this.getValidSubItems(n, t, e.type, e.startIndex)
      }, getValidSubItems: function (e, t, n, r) {
        var o = this, i = r, a = new RegExp(t, "g"), u = this.getSubType(n);
        return e.reduce(function (e, t, n, r) {
          var s = t, l = !s.match(a) && Object.prototype.hasOwnProperty.call(s, "length") && s.length > 0;
          if (l) {
        ...
        var t = this.getAdverbs(e), n = this.getQualifiers(e), r = this.getPassiveVoices(e),
        ...
        return n ? n.filter(function (e) {
          ...
          if (!t) return !1;
          var n = t[1], r = n.match(/ed$/) || void 0 !== u.default[n.toLowerCase()];
          return r
        }).map(function (e) {
          return e.replace(/^\s/, "")
        }).map(function (n, r, o) {
        ...
        var o = e.startIndex, i = e.text, a = function (e) {
          return e.filter(function (e) {
            return t === e
          })
        }, u = a(r), s = u.length > 1;
        if (s) {
          ...
          return l.reduce(function (e, t) {
            var n = e;
            0 !== n && (n += 1);
            var r = i.substr(n), o = r.indexOf(t);
            return n + o
          }, 0) + o
        }
        ...
        return a.forEach(function (i, u) {
          var s = i.text, l = i.sentenceIndex, c = [s];
          a[u + 1] && a[u + 1].sentenceIndex === l + s.length + 1 && (c.push(s + " " + a[u + 1].text), a[u + 2] && a[u + 2].sentenceIndex === l + 1 + c[1].length && (c.push(c[1] + " " + a[u + 2].text), a[u + 3] && a[u + 3].sentenceIndex === l + 1 + c[2].length && c.push(c[2] + " " + a[u + 3].text))), c.reverse().forEach(function (i) {
            if (void 0 !== t[i.toLowerCase()]) {
              var a = r.buildTreeFragment(n, i, e.startIndex + l), u = r.addTrailingSpaceSetting(a, e);
              o.push(u)
            }
          })
        }), o
      }, addTrailingSpaceSetting: function (e, t) {
        var n = e.startIndex + e.text.length - t.startIndex, r = t.text.charAt(n), o = Object.assign({}, e);
  ...
  Object.defineProperty(t, "__esModule", {value: !0});
  var o = n(37), i = r(o), a = n(16), u = r(a), s = {
    removeOldBlocks: function (e, t) {
      ...
      return e.reduce(function (e, t) {
        var n = t.stats, r = n.letters, o = n.characters, i = n.words, a = n.sentences, s = n.paragraphs,
          l = n.readingSeconds, c = t.stats.highlights, d = c.adverbs, f = c.passiveVoices,
          p = c.complexWords, h = c.hardSentences, y = c.veryHardSentences;
  ...
  function o(e, t) {
    var n = e.substr(0, 1).match(/[A-Z]/), r = e.substr(0, 2).match(/[A-Z]{2}/), o = void 0, i = void 0;
    switch (t) {
      case s.default.tokens.adverb:
        return o = "Use a forceful verb.", {message: o, replacements: ["omit"]};
      case s.default.tokens.qualifier:
        return o = "Be bold. Don't hedge.", {message: o, replacements: ["omit"]};
      case s.default.tokens.vaguePhrase:
        return o = "Be specific.", {message: o, replacements: ["omit"]};
      case s.default.tokens.passiveVoice:
        return o = "Use active voice.", {message: o, replacements: []};
      case s.default.tokens.complexWord:
        ...
        })), {message: o, replacements: i};
      case s.default.tokens.buzzword:
      case s.default.tokens.cliche:
        return o = "Be original.", {message: o, replacements: ["omit"]};
      default:
  ...
  Object.defineProperty(t, "__esModule", {value: !0}), t.default = o;
  var i = n(17), a = r(i), u = n(2), s = r(u), l = n(9)
}, function (e, t) {
  "use strict";
  var n = {
      childContextTypes: !0,
  ...
  var r = n(64), o = Object.getPrototypeOf, i = r(o, Object);
  e.exports = i
}, function (e, t) {
  function n(e) {
    var t = !1;
  ...
  var u = n(1), s = n(18), l = r(s), c = n(19), d = (r(c), function (e) {
    function t(n, r) {
      o(this, t);
  ...
  function l(e, t, n) {
    var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, l = Boolean(e), f = e || k,
      h = void 0;
    h = "function" == typeof t ? t : t ? (0, v.default)(t) : P;
    var g = n || O, m = r.pure, b = void 0 === m || m, w = r.withRef, S = void 0 !== w && w, M = b && g !== O,
      I = x++;
    return function (e) {
      function t(e, t, n) {
        var r = g(e, t, n);
      ...
      var n = "Connect(" + u(e) + ")", r = function (r) {
        ...
        return a(u, r), u.prototype.shouldComponentUpdate = function () {
          ...
          var f = !0;
          return f = !!(s || l || t) && this.updateMergedPropsIfNeeded(), !f && i ? i : (S ? this.renderedElement = (0, d.createElement)(e, c({}, this.mergedProps, {ref: "wrappedInstance"})) : this.renderedElement = (0, d.createElement)(e, this.mergedProps), this.renderedElement)
        }, u
      }(d.Component);
      return r.displayName = n, r.WrappedComponent = e, r.contextTypes = {store: p.default}, r.propTypes = {store: p.default}, (0, T.default)(r, e)
    }
  }
  ...
  t.default = l;
  var d = n(1), f = n(18), p = r(f), h = n(68), y = r(h), g = n(69), v = r(g), m = n(19), b = (r(m), n(10)),
    w = (r(b), n(56)), T = r(w), S = n(57), _ = r(S), k = function (e) {
      return {}
    }, P = function (e) {
      return {dispatch: e}
    }, O = function (e, t, n) {
